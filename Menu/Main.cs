...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void Prefix()
        {
            ...
            if (menu != null)
            {
                if (buttonLayout == 2) // plz help -- this took like 6 mins :sob: - silent
                {
                    if (!btnDelay)
                    {
                        if (ControllerInputPoller.instance.leftControllerIndexFloat > 0.5f || UnityInput.Current.GetKey(KeyCode.Minus))
                        {
                            Toggle("PreviousPage");
                            GorillaTagger.Instance.offlineVRRig.PlayHandTapLocal(67, rightHanded, 0.9f);
                            btnDelay = true;
                            lastBtnPressTime = Time.time;
                        }
                        if (ControllerInputPoller.instance.rightControllerIndexFloat > 0.5f || UnityInput.Current.GetKey(KeyCode.Plus))
                        {
                            Toggle("NextPage");
                            GorillaTagger.Instance.offlineVRRig.PlayHandTapLocal(67, rightHanded, 0.9f);
                            btnDelay = true;
                    ...
                    if (btnDelay && Time.time - lastBtnPressTime > btnCooldownTime)
                    {
                        btnDelay = false;
                    }
                }
        ...
        public static void CreateMenu()
        {
            ...
            // Title and FPS
                ...
                text.text = PluginInfo.Name + " <color=magenta>[</color><color=purple>" + (pageNumber + 1).ToString() + "</color><color=magenta>]</color>";
                text.fontSize = 1;
            ...
            // Buttons
                // Disconnect
                    if (disconnectButton)
                    {
                        ...
                        rectt.sizeDelta = new Vector2(0.2f, 0.016f);
            ...
            if (buttonLayout == 0)
            {
                gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.9f); // default
                gameObject.transform.localPosition = new Vector3(0.56f, 0.55f, 0); // default
            }
            else if (buttonLayout == 1)
            {
                gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.06f); // top
                gameObject.transform.localPosition = new Vector3(0.56f, 0.30f, 0.54f); // top
            }
            else if (buttonLayout == 2)
            {
                gameObject.transform.localScale = Vector3.zero; // triggers
                gameObject.transform.localPosition = Vector3.zero; // triggers
            }
            else if (buttonLayout == 3)
            {
                gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.06f); // bottem
                gameObject.transform.localPosition = new Vector3(0.56f, 0.30f, -0.54f); // bottem
            }
            ...
            if (buttonLayout == 0)
            {
                gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.9f); // default
                gameObject.transform.localPosition = new Vector3(0.56f, -0.55f, 0); // default
                GetIndex("Change Button Layout").overlapText = "Change Button Layout : Sides";
            }
            else if (buttonLayout == 1)
            {
                gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.06f); // top
                gameObject.transform.localPosition = new Vector3(0.56f, -0.30f, 0.54f); // top
                GetIndex("Change Button Layout").overlapText = "Change Button Layout : Top";
            }
            else if (buttonLayout == 2)
            {
                gameObject.transform.localScale = Vector3.zero; // triggers
                gameObject.transform.localPosition = Vector3.zero; // triggers
                GetIndex("Change Button Layout").overlapText = "Change Button Layout : Triggers";
            }
            else if (buttonLayout == 3)
            {
                gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.06f); // bottem
                gameObject.transform.localPosition = new Vector3(0.56f, -0.30f, -0.54f); // bottem
                GetIndex("Change Button Layout").overlapText = "Change Button Layout : Bottem";
            }
            gameObject.GetComponent<Renderer>().material.color = buttonColors[0].colors[0].color;
                ...
                // Mod Buttons
                    ...
                    {
                        CreateButton(i * 0.102f, activeButtons[i]);
                    }
        }
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.parent = menu.transform;
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.09f, 0.63f, 0.08f);
            ...
            RectTransform component = text.GetComponent<RectTransform>();
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(.2f, .014f);
                ...
                } else
                {
                    ...
                    if (target != null)
                    {
                        if (target.isTogglable)
                        {
                            ...
                            if (target.enabled)
                            {
                                NotifiLib.SendNotification("<color=blue>[MOD]</color> " + target.toolTip);
        ...
        // Data
            ...
            public static bool btnDelay = false;
            private static float btnCooldownTime = 0.3f;
            private static float lastBtnPressTime = 0f;
